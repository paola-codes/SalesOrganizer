      ...
      <div className="container-fluid bg-light p-4 m-0">
        <div className="row p-0 m-0 mb-3 d-flex d-inline-column flex-wrap">
          ...
          <div className="col p-0 d-flex align-items-start flex-column">
            <div className="col mb-3 p-2 bg-primary bg-opacity-25 w-100">
              <h4>
        ...
        <div className="row d-inline-flex justify-content-start p-0 m-0">
          <div className="col p-0 m-0">
            ...
            <button
              type="button"
              className="btn btn-danger me-3 m-0 fs-5"
            ...
            <Link to="/HomePage">
              <button type="button" className="btn btn-secondary me-3 m-0 fs-5">
                Home
              </button>
            </Link>
          </div>
